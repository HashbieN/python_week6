# The Python Square Calculator (Command Line Edition)
...
print("\nThe Python Square Calculator\n")

for sq in range(1, 11):  # loops from index 1 to 10 because end = end-1

    square = sq ** 2

    print("The square of", sq, "is:", square)
